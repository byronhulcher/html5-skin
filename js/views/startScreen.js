  ...
  render: function() {
    ...
    return (
      <div className="state-screen startScreen">
        ...
        {(this.state.playButtonClicked && this.props.controller.state.playerState == CONSTANTS.STATE.START) || this.props.controller.state.buffering ? <Spinner {... this.props} /> : actionIcon}
      </div>
    );
  }
});
